...
def compute_sift_keypoints2(filename_rgb,filename_dep):
    ...
    sift1.setContrastThreshold(0.03)
    sift1.setEdgeThreshold(20)

    sift2.setContrastThreshold(0.005)
    sift2.setEdgeThreshold(15)    
...
def compute_fundamental_matrix(file1_rgb, file1_dep,file2_rgb,file2_dep,Mode=None):
    """
    ...
    img1, kp1, des1 = compute_sift_keypoints2(file1_rgb, file1_dep)
    img2, kp2, des2 = compute_sift_keypoints2(file2_rgb,file2_dep)

    # print the number of keypoints detected in the training image
    print("Number of Keypoints Detected In The final Image: ", len(kp1))
    ...
    img_final=show_matches(img1,kp1,des1,img2,kp2,des2,Mode)

    cv2.imshow("Inlier Matches Base", img_base)
    cv2.imshow("Inlier Matches With Depth", img_final)
...
def main():
    ...
    with open(filename) as file:
      for item in file:
        ...
        file1_rgb = '/home/wang/Desktop/project/Monocular-Depth-Estimation-Toolbox/data_rgb/'+terms[0]        
        file1_dep = '/home/wang/Desktop/project/Monocular-Depth-Estimation-Toolbox/data_dep/'+terms[0]

        file2_rgb = '/home/wang/Desktop/project/Monocular-Depth-Estimation-Toolbox/data_rgb/'+terms[1]
        file2_dep = '/home/wang/Desktop/project/Monocular-Depth-Estimation-Toolbox/data_dep/'+terms[1]
